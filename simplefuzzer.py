...
#Credit for this tool goes to Muhannad. I found it on their repo and tweaked it a bit to my liking. This really expedites the process of fuzzing and finding the offset
#Using Metasploit's pattern create and pattern offset tools.
